...
begin
  FDataListBind.AddBind(aComponentName, aObjectPropertyName, [], nil);
end;
...
begin
  FDataListBind.AddBind(aComponentName, aObjectPropertyName, aMiddlewares, nil);
end;
procedure TOrionBindings.AddListBind(aComponentName: string; aImage: TObject);
begin
  FDataListBind.AddBind(aComponentName, '', [], TBitmap(aImage));
end;
